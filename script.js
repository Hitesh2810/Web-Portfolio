...
const projects = [
    ...
    { title: "Voice-Vista", desc: "Multilingual voice-controlled intuitive web application.", tech: ["Node.js", "WebSpeech API"], img: "https://i.postimg.cc/tJMYk6Q1/VV.png", imageClass: "project-img-contain" },
    { title: "SaaS-Notes-App", desc: "High-performance cloud-based note taking application.", tech: ["React", "Firebase"], img: "https://i.postimg.cc/fbfQDhb7/ss.png", imageClass: "project-img-contain", github: "https://github.com/Hitesh2810/SaaS-Notes-App" },
    { title: "LeadHub", desc: "Enterprise-grade lead management and CRM system.", tech: ["JavaScript", "Express"], img: "https://i.postimg.cc/LsYgbN6B/lh.png", imageClass: "project-img-contain", github: "https://github.com/Hitesh2810/LeadHub" },
    { title: "RnD_AI_CurveFit", desc: "Parametric curve fitting using custom ML algorithms.", tech: ["Python", "NumPy", "Scikit"], img: "https://i.postimg.cc/FK5hhZVx/rnd.png", imageClass: "project-img-contain" },
    { title: "Capex-Tracker", desc: "Financial tracking for capital expenditures.", tech: ["React", "Charts.js"], img: "https://i.postimg.cc/LsbBqJhX/ct.png", imageClass: "project-img-contain", github: "https://github.com/Hitesh2810/capex-tracker" },
    { title: "Code-Tree", desc: "Visualizing complex Data Structures and Algorithms.", tech: ["Canvas API", "Algorithms"], img: "https://i.postimg.cc/Yqz66njs/ctr.png", imageClass: "project-img-contain" },
    { title: "WebSleuth", desc: "Web security and vulnerability assessment tool.", tech: ["Security", "Python"], img: "https://i.postimg.cc/4y7JJFqV/wb.png", imageClass: "project-img-contain", github: "https://github.com/Hitesh2810/WebSleuth-Hitesh" },
